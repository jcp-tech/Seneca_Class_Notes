...
class LidarController:
    def __init__(self, name):
        ...
        self.set_parameters_srv = rospy.Service(self.name + '/set_parameters', SetFloat64List, self.set_parameters_srv_callback)  # 参数设置(set parameters)
    ...
    def enter_srv_callback(self, _):
        ...
        self.reset_value()
        self.lidar_sub = rospy.Subscriber('/scan', sensor_msg.LaserScan, self.lidar_callback) # 订阅雷达数据(subscribe to Lidar data)
