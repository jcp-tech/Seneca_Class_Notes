...
class OjbectTrackingNode:
    def __init__(self, name):
        ...
        self.set_running_srv = rospy.Service(self.name + '/set_running', SetBool, self.set_running_srv_callback)
        self.set_target_color_srv = rospy.Service(self.name + '/set_target_color', SetPoint, self.set_target_color_srv_callback)
        self.get_target_color_srv = rospy.Service(self.name + '/get_target_color', Trigger, self.get_target_color_srv_callback)
        self.set_threshold_srv = rospy.Service(self.name + '/set_threshold', SetFloat64, self.set_threshold_srv_callback)
